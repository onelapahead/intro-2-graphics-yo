...
var uvBuffers = []; // this contains uv coordinate lists by set, in doubles
...
function setupShaders() {
    ...
    var fShaderCode = `
        ...
        void main(void) {
            ...
            gl_FragColor = vec4(colorOut, uAlpha) * texture2D(uTexture, vec2(vTextureCoords.s, vTextureCoords.t));
        }
    `;
